...
class DatabaseQuery:
    ...
    def load_Single_LAS_File_From_Email(self, las_file_content): # Not to be used. Instead use import function in IMPEX module
        # Code to execute when button 2 is clicked
        datasetname = "WIRE"
        import io
        ...
        top = las.well.STRT.value
        bottom = las.well.STOP.value
        dataset = Dataset.from_las_attachement(las_file_content,dataset_name=datasetname, dataset_type='Cont', well_name=wellname)
